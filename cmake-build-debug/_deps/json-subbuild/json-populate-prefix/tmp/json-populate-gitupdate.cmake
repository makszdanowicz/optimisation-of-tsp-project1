...
execute_process(
  COMMAND "D:/Git/cmd/git.exe" --git-dir=.git show-ref "v3.11.2"
  WORKING_DIRECTORY "D:/projekty_Clion_c/optimisation-of-tsp-project1/cmake-build-debug/_deps/json-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'D:/projekty_Clion_c/optimisation-of-tsp-project1/cmake-build-debug/_deps/json-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'D:/projekty_Clion_c/optimisation-of-tsp-project1/cmake-build-debug/_deps/json-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
